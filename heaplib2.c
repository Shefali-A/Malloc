...
void *hl_alloc(void *heap_ptr, unsigned int payload_size) {
	...
	if((current == NULL) || (current > (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer)))) || (current < (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead)))) {
		return 0;
	}
	...
	if (difference >= minimum_space) {
		...
		if ((current->prev != NULL) && (current->prev >= (header *)ADD_BYTES(heapmeta, heapmeta->beforefirstfreehead)) && (current->prev <= (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer))))) {
			current->prev->next = current->next;
		}

		if ((current->next != NULL) && (current->next >= (header *)ADD_BYTES(heapmeta, heapmeta->beforefirstfreehead)) && (current->next <= (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer))))) {
...
void hl_release(void *heap_ptr, void *payload_ptr) {
	...
	if ((next_header->free == true) && (next_header <= (allocheader *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer))))) {
		...
		if((next_header->prev != NULL) && (next_header->prev >= (header *)ADD_BYTES(heapmeta, heapmeta->beforefirstfreehead)) && (next_header->prev <= (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer))))) {
			next_header->prev->next = next_header->next;
		}
		if((next_header->next != NULL) && (next_header->next <= (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer)))) && (next_header->next >= (header *)ADD_BYTES(heapmeta, heapmeta->beforefirstfreehead))) {
	...
	if ((prev_footer->free == true) && (prev_footer >= (footer *)ADD_BYTES(heapmeta, heapmeta->beforefirstfreehead))) {
		...
		new_release_header->size = total_size;
		if((prev_header->prev != NULL) && (prev_header->prev >= (header *)ADD_BYTES(heapmeta, heapmeta->beforefirstfreehead)) && (prev_header->prev <= (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer))))) {
			prev_header->prev->next = prev_header->next;
		}
		if((prev_header->next != NULL) && (prev_header->next <= (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer)))) && (prev_header->next >= (header *)ADD_BYTES(heapmeta, heapmeta->beforefirstfreehead))) {
...
void *hl_resize(void *heap_ptr, void *payload_ptr, unsigned int new_size) {
	...
	uintptr_t minimum_space = sizeof(header) + sizeof(footer);
	uintptr_t difference = (uintptr_t)old_size - (uintptr_t)new_size;
	if ((old_size >= new_size) && (difference >= minimum_space)) {
		...
		if ((next_header->free == true) && (next_header <= (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer))))) {
			uintptr_t next_header_size = next_header->size;
			footer *next_footer = (footer *) ADD_BYTES(next_header, (sizeof(header) + next_header_size));
	...
	if ((firstfreepointer == NULL) || (firstfreepointer > (header *)ADD_BYTES(heapmeta, (heapmeta->beforefirstfreehead + heapmeta->heapsize - sizeof(header) - sizeof(footer)))) || (firstfreepointer < (header*)ADD_BYTES(heapmeta, heapmeta->beforefirstfreehead))) {
		return 0;
	}
